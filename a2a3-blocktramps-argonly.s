...
.text
    .private_extern __a2a3_tramphead_argonly
    .private_extern __a2a3_firsttramp_argonly
    .private_extern __a2a3_nexttramp_argonly
    .private_extern __a2a3_trampend_argonly

.align 12
__a2a3_tramphead_argonly:
	popl %eax
	andl $0xFFFFFFF8, %eax
	subl $0x1000, %eax
...
.align 5
__a2a3_firsttramp_argonly:
    TrampolineEntry
__a2a3_nexttramp_argonly:
    TrampolineEntry
    TrampolineEntry
    TrampolineEntry
    TrampolineEntry
...
.macro TrampolineEntry
callq __a2a3_tramphead_argonly
nop
nop
nop
.endmacro
...
#ifdef _ARM_ARCH_7
.thumb
.thumb_func __a2a3_tramphead_argonly
.thumb_func __a2a3_firsttramp_argonly
.thumb_func __a2a3_nexttramp_argonly
.thumb_func __a2a3_trampend_argonly
#else
// don't use Thumb-1
.arm
#endif
...
adr  r12, __a2a3_tramphead_argonly    // text page
