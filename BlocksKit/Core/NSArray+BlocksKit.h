...
/**
 ...
 We can use a block to make it simpler:
	 ...
	 NSArray *peoples = @[p1, p2, p3];
	 NSInteger totalAge = [peoples reduceInteger:0 withBlock:^(NSInteger result, ObjectType obj, NSInteger index) {
...
/**
 ...
 We can use a block to make it simpler:
	 ...
	 NSArray *peoples = @[p1, p2, p3];
	 CGFloat totalBalance = [peoples reduceFloat:.0f WithBlock:^CGFloat(CGFloat result, ObjectType obj, NSInteger index) {
